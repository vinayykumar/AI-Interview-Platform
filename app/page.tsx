            ...
            <div className="relative">
                ...
                <div className="relative mx-auto">
                    <div className="lg:max-w-6xl lg:mx-auto">
                        ...
                        <img className="transform scale-110" src="../public/HeroImg.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
